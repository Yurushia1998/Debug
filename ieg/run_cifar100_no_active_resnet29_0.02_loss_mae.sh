...
CUDA_VISIBLE_DEVICES=0 python -m ieg.main --dataset=cifar100_uniform_0.8  --network_name=resnet29 --probe_dataset_hold_ratio=0.002 --active=False --checkpoint_path=ieg/checkpoints/ieg --noise_pretrained=ieg/data_noise_pretrained/cifar100/0.8_sym.json --using_loss="MAE"