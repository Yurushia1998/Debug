...
CUDA_VISIBLE_DEVICES=0 python -m ieg.main --dataset=cifar100_uniform_0.8 --network_name=resnet29 --probe_dataset_hold_ratio=0.002 --checkpoint_path=ieg/checkpoints/ieg --model_path=ieg/pretrained/model_sym_0.8_cifar100_300_64_.pth --AL_model=DivideMix  --num_img=10000 --select_by_gradient=True --diverse_and_balance="only_clean_balance_mix_by_class_real_features_cosine" --num_clean=100 --noise_pretrained=ieg/data_noise_pretrained/cifar100/0.8_sym.json --warmup_iteration=0 --use_GMM_pseudo_classification=True 